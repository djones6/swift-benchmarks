...
for i in 1...MAX_CONCURRENCY {
  // These both result in bad scalability when STRING was user input - why??
  // var s = "\(STRING)"
  // let s = String(STRING.utf8)!
  // This performs consistently regardless of whether STRING was user input
  let s = String(data: Data(STRING.utf8), encoding: .utf8)!
  STRINGS.append(s)
}
