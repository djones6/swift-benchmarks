//
//  ConvTest.swift
//  A simple workload to measure the overhead of synchronization in the __CFGetConverter
//  Linux Foundation code.
//  See: https://github.com/apple/swift-corelibs-foundation/pull/414
//
